...
**
** Created: Thu May 31 14:53:54 2012
...
static const char qt_meta_stringdata_TwitterConnection[] = {
    ...
    "onAuthorizedRequestDone()\0ready()\0"
};

void TwitterConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        TwitterConnection *_t = static_cast<TwitterConnection *>(_o);
        switch (_id) {
        case 0: _t->tmpToken(); break;
        case 1: _t->success(); break;
        case 2: _t->accessToken((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 3: _t->onAuthorizedRequestDone(); break;
...
const QMetaObjectExtraData TwitterConnection::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TwitterConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TwitterConnection,
      qt_meta_data_TwitterConnection, &staticMetaObjectExtraData }
};
