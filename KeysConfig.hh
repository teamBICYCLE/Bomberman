...
# define KEYS_FILE_P1       "config/player1.conf"
# define KEYS_FILE_P2       "config/player2.conf"
# define UP_CFG             "[UP]"
...
private:
    void getFileDataPlayer1(void);
    void getFileDataPlayer2(void);
...
private:
    ...
    std::list<std::string> fileDataP1_;
    std::list<std::string> fileDataP2_;
};
